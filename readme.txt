...
　URLでよく見かけますが、日本語のままではうまく稼働しないブラウザに対応するためコード化しているそうな
　エンコードは文字コードによって異なります
　URLでは基本的にUTF-8を使うものと思っていたのですがUTF-8ではなさそうです
　
...
　echoの中身が％エンコーディングですが、基本インターネットからのコピペ
 パイプ（|）で処理を連結させて以下の処理をします
